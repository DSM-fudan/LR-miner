...
import com.infomatiq.jsi.rtree.PriorityQueue;
import com.infomatiq.jsi.rtree.SpatialIndex;
...
//        deleteLog.debug("searching node " + n.nodeId + ", from index " + startIndex);
  ...
  /**
   * @see com.infomatiq.jsi.SpatialIndex#nearest(Point, TIntProcedure, )
   */
...
//    intersects(r, leafs, rootNode);
    return leafs;
  }
  // Given a polygon, return the UpperBound. defined by MaYuanwen
  ...
  // Given a PLASegment, return the UpperBound defined by MaYuanwen
