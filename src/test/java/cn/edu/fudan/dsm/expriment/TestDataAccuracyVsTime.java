...
public class TestDataAccuracyVsTime {
	public void segmentBasedOptimizationTest(String fileName, double errorBound, double error, int baseBound, int length, int period)
		...
		String outFile1 = "data/experiments/testData_AccuracyVsTime_pointBasedOptimization(errorBound=" + errorBound + "error=" + error
				+ "baseBound=" + baseBound + "length=" + length + "peroid=" + tempPriod + "s_trueAccuracy).txt";
		String outFile2 = "data/experiments/testData_AccuracyVsTime_pointBasedOptimization(errorBound=" + errorBound + "error=" + error
	...
	public static void main(String[] args) throws IOException{
		...
		TestDataAccuracyVsTime expr = new TestDataAccuracyVsTime();
