...
public class RondomDataTimeVsLength {
	
	public void segmentBasedTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/Random_TimeVsLength_segmentBased(errorBound=" + errorBound + "error=" + error + ").txt";
	...
	public void segmentBasedOptimizationTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/Random_TimeVsLength_segmentBasedOptimization(errorBound=" + errorBound + "error=" + error + ").txt";
		String line1 = "";	// Time series length
	    String line2 = ""; 	// Running time
	    PrintWriter pw = new PrintWriter(new FileWriter(outFile));
	...
	public void pointBasedTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/Random_TimeVsLength_pointBased(errorBound=" + errorBound + "error=" + error + ").txt";
		String line1 = "";	// Time series length
	    String line2 = ""; 	// Running time
	    PrintWriter pw = new PrintWriter(new FileWriter(outFile));
	...
	public void pointBasedOptimizationTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/Random_TimeVsLength_pointBasedOptimization(errorBound=" + errorBound + "error=" + error + ").txt";
		String line1 = "";	// Time series length
	    String line2 = ""; 	// Running time
	    PrintWriter pw = new PrintWriter(new FileWriter(outFile));
	...
	public static void main(String[] args) throws IOException{
		String fileName = "data/experiments/test_10000_4.txt";
		double errorBound = 1;
		double error = 0.05;
		int[] segLength = {100, 500, 1000, 2000, 5000, 10000};
		
		RondomDataTimeVsLength expr = new RondomDataTimeVsLength();
