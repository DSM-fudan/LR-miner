 ...
 */
public class TemperatureTimeVsDelta {

    private static Logger logger = Logger.getLogger(TemperatureTimeVsDelta.class);
    ...
    public static void main(String args[]) throws IOException {
        TemperatureTimeVsDelta tss = new TemperatureTimeVsDelta();
        double errorBound = 0.1;
        int duration = 19359;

//        tss.searchAllWithPointBasedOpti(19, duration, errorBound, 0.01, 3, true, 50000);
//        tss.searchAllWithPointBasedOpti(19, duration, errorBound, 0.05, 3, true, 50000);
//        tss.searchAllWithPointBasedOpti(19, duration, errorBound, 0.10, 3, true, 50000);
        tss.searchAllWithPointBasedOpti(19, duration, errorBound, 0.15, 3, true, 50000);
//        tss.searchAllWithPointBasedOpti(19, duration, errorBound, 0.20, 3, true, 50000);
    }
...
//            print.println(baseStation + "," + targetStation + "," + pearsonCorrelation + "," + k + "," + b + "," + plaRegionSearch.finalLength + "," + plaRegionSearch.maxUpBound);
        ...
        System.out.println(error + "," + averageTime);
