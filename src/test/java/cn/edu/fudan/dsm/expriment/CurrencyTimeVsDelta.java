 ...
 */
public class CurrencyTimeVsDelta {

    private static Logger logger = Logger.getLogger(CurrencyTimeVsDelta.class);

    private static final String[] currencies = {"CAD", "CHF", "CZK", "DKK", "HKD", "HUF", "JPY", "MXN", "NOK", "PLN", "SEK", "SGD", "TRY", "ZAR"};

    public static void main(String args[]) throws IOException {
        CurrencyTimeVsDelta css = new CurrencyTimeVsDelta();
        double errorBound = 0.1;

//        css.searchAllWithPointBasedOpti("HKD", errorBound, 0.01, 3, true, 50000);
//        css.searchAllWithPointBasedOpti("HKD", errorBound, 0.05, 3, true, 50000);
//        css.searchAllWithPointBasedOpti("HKD", errorBound, 0.10, 3, true, 50000);
        css.searchAllWithPointBasedOpti("HKD", errorBound, 0.15, 3, true, 50000);
//        css.searchAllWithPointBasedOpti("HKD", errorBound, 0.20, 3, true, 50000);
    }
