 ...
 */
public class TemperatureTimeVsEpsilon {

    private static Logger logger = Logger.getLogger(TemperatureTimeVsEpsilon.class);
    ...
    public static void main(String args[]) throws IOException {
        TemperatureTimeVsEpsilon tss = new TemperatureTimeVsEpsilon();
        double error = 0.05;
        int duration = 19359;

        tss.searchAllWithPointBasedOpti(19, duration, 0.05, error, true, 50000);
        tss.searchAllWithPointBasedOpti(19, duration, 0.10, error, true, 50000);
        tss.searchAllWithPointBasedOpti(19, duration, 0.15, error, true, 50000);
        tss.searchAllWithPointBasedOpti(19, duration, 0.20, error, true, 50000);
        tss.searchAllWithPointBasedOpti(19, duration, 0.50, error, true, 50000);
    }

    private void searchAllWithPointBasedOpti(int type, int duration, double errorBound, double error, boolean z_normalization, int length) throws IOException {
