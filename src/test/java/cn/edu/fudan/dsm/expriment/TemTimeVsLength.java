...
public class TemTimeVsLength {
	
	public void segmentBasedTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/tem+GST_TimeVsLength_segmentBased(errorBound=" + errorBound + "error=" + error + ").txt";
	...
	public void segmentBasedOptimizationTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/tem+GST_TimeVsLength_segmentBasedOptimization(errorBound=" + errorBound + "error=" + error + ").txt";
		String line1 = "";	// Time series length
	    String line2 = ""; 	// Running time
	    PrintWriter pw = new PrintWriter(new FileWriter(outFile));
	...
	public void pointBasedTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/tem+GST_TimeVsLength_pointBased(errorBound=" + errorBound + "error=" + error + ").txt";
		String line1 = "";	// Time series length
	    String line2 = ""; 	// Running time
	    PrintWriter pw = new PrintWriter(new FileWriter(outFile));
	...
	public void pointBasedOptimizationTest(String fileName, double errorBound, double error, int[] segLength) throws IOException{
		String outFile = "data/experiments/tem+GST_TimeVsLength_pointBasedOptimization(errorBound=" + errorBound + "error=" + error + ").txt";
		String line1 = "";	// Time series length
	    String line2 = ""; 	// Running time
	    PrintWriter pw = new PrintWriter(new FileWriter(outFile));
	...
	public static void main(String[] args) throws IOException{
		...
		double errorBound = 1;
		double error = 0.05;
		int[] segLength = {20000, 40000, 60000, 80000, 100000};
		
		TemTimeVsLength expr = new TemTimeVsLength();
